...
public class AdapterRecylerview_MySaloons extends RecyclerView.Adapter<AdapterRecylerview_MySaloons.MyViewHolder> {

    Context mContext;
    ArrayList<Helper_HitListModel> hitListData;

    public AdapterRecylerview_MySaloons(Context mContext, ArrayList<Helper_HitListModel> hitListData) {
