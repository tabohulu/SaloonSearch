...
public class Fragment_Appointment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment__appointment, container, false);
        addAppointmentImage=view.findViewById(R.id.fragment_appointment_add_appointment);
        noAppointment=view.findViewById(R.id.fragment_appointment_no_appointment);

        addAppointmentImage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
            if(getContext() instanceof Activity_Homepage){
                ((Activity_Homepage)getContext()).SwitchPage(2);
            }
            }
        });
